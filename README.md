...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/headerparser-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15592&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/headerparser-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `headerparser` can be installed with:

```
conda install headerparser
```

It is possible to list all of the versions of `headerparser` available on your platform with:
